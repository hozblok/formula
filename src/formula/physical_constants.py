...
# Zysk 2012 glass (Opt. Express 20, 3975): eps = 1 - 9.115e-6 + i*1.145e-7 at
# 8 keV; electron density back-derived from delta = 4.5575e-6.
ZYSK_ELECTRON_DENSITY = "4.2308e29"  # electrons / m^3
ZYSK_BETA_REF = "5.725e-8"           # absorption index at the reference energy
ZYSK_ENERGY_REF_KEV = "8.0"          # reference photon energy (keV)
